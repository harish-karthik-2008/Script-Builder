...
const DEFAULT_SCRIPT = () => ({
  ...
  blocks: [
    { id: crypto.randomUUID(), type: "scene", content: "INT. WRITER'S ROOM - DAY" },
    {
      id: crypto.randomUUID(),
      type: "action",
      content:
        "A clean screenplay editor opens on the screen. The writer starts shaping scenes, dialogue, and ideas with ease.",
    },
    { id: crypto.randomUUID(), type: "character", content: "WRITER" },
    { id: crypto.randomUUID(), type: "dialogue", content: "This feels like a real script writing app." },
  ],
});
...
function getBlockStyle(type) {
  ...
  switch (type) {
    ...
    case "dialogue":
      return `${base} md:px-24`;
    case "parens":
      return `${base} md:px-28 italic text-slate-500`;
    case "lyrics":
...
function blockWrapper(type) {
  switch (type) {
    ...
    case "parens":
      return "bg-rose-50 border-rose-200 md:mx-24";
    case "dialogue":
      return "bg-white border-slate-200 md:mx-12";
    case "transition":
...
export default function App() {
  ...
  const addBlock = (type, index = activeScript.blocks.length) => {
              ...
              <div className="space-y-3 overflow-y-auto pb-24">
                {filteredScripts.map((script) => (
                  ...
                  >
                    ...
                    <p className={`mt-3 text-xs ${script.id === activeId ? "text-slate-400" : "text-slate-400"}`}>
          ...
          <div className="px-3 py-4 md:px-8 md:py-8">
            ...
            {viewMode === "preview" && (
              <div className="mx-auto max-w-4xl rounded-[28px] border border-slate-300 bg-white p-6 shadow-xl md:p-10">
                ...
                <div className="space-y-5 font-mono text-[15px] leading-7">
...
function PreviewBlock({ block }) {
  ...
  const cls = {
    ...
    parens: "text-center italic text-slate-500",
    dialogue: "mx-auto max-w-2xl",
